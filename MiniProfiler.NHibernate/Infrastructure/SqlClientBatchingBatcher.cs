...
using NHibernate;
using Cfg = global::NHibernate.Cfg;
...
//## Different from https://github.com/nhibernate/nhibernate-core/blob/master/src/NHibernate/AdoNet/SqlClientBatchingBatcher.cs
            _currentBatch.Append(GetSqlCommand(batchUpdate));
//##
...
//## Different from https://github.com/nhibernate/nhibernate-core/blob/master/src/NHibernate/AdoNet/SqlClientBatchingBatcher.cs
        protected virtual System.Data.SqlClient.SqlCommand GetSqlCommand(IDbCommand batchUpdate)
        {
            return (System.Data.SqlClient.SqlCommand)batchUpdate;
        }
//##
    }
}